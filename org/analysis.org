...
#+BEGIN_SRC R :results silent :session rough.estimation.inst.rate :exports both
d.4b.4c.I<-cbind(dataset.tic.lu.16.comp.4b.I[,1:4], dataset.tic.lu.16.comp.4b.I$avg/1e6, dataset.tic.lu.16.comp.4c.I$avg*1e3)
d.4b.4c.II<-cbind(dataset.tic.lu.16.comp.4b.II[,1:4], dataset.tic.lu.16.comp.4b.II$avg/1e6, dataset.tic.lu.16.comp.4c.II$avg*1e3)
d.4b.4c.III<-cbind(dataset.tic.lu.16.comp.4b.III[,1:4], dataset.tic.lu.16.comp.4b.III$avg/1e6, dataset.tic.lu.16.comp.4c.III$avg*1e3)
d.4b.4c.IV<-cbind(dataset.tic.lu.16.comp.4b.IV[,1:4], dataset.tic.lu.16.comp.4b.IV$avg/1e6, dataset.tic.lu.16.comp.4c.IV$avg*1e3)
d.4b.4c.V<-cbind(dataset.tic.lu.16.comp.4b.V[,1:4], dataset.tic.lu.16.comp.4b.V$avg/1e6, dataset.tic.lu.16.comp.4c.V$avg*1e3)

colnames(d.4b.4c.I)[5:6]<-c("COMP.4b.avg", "COMP.4c.avg")
colnames(d.4b.4c.II)[5:6]<-c("COMP.4b.avg", "COMP.4c.avg")
colnames(d.4b.4c.III)[5:6]<-c("COMP.4b.avg", "COMP.4c.avg")
colnames(d.4b.4c.IV)[5:6]<-c("COMP.4b.avg", "COMP.4c.avg")
colnames(d.4b.4c.V)[5:6]<-c("COMP.4b.avg", "COMP.4c.avg")
#+END_SRC
...
inst_rate<-c(mean(d.4b.4c.I$COMP.4c.avg/d.4b.4c.I$COMP.4b.avg),
     mean(d.4b.4c.II$COMP.4c.avg/d.4b.4c.II$COMP.4b.avg),
     mean(d.4b.4c.III$COMP.4c.avg/d.4b.4c.III$COMP.4b.avg),
     mean(d.4b.4c.IV$COMP.4c.avg/d.4b.4c.IV$COMP.4b.avg),
     mean(d.4b.4c.V$COMP.4c.avg/d.4b.4c.V$COMP.4b.avg))
...
#+BEGIN_SRC R :results output graphics :file "R-analysis/plots/inst.rate.dataset.1.png" :exports both :width 600 :height 400 :session rough.estimation.inst.rate
ggplot(d.4b.4c.I, aes(x=1:nrow(d.4b.4c.I),
...
#+RESULTS:
[[file:../R-analysis/plots/inst.rate.dataset.1.png]]

*Dataset 2*

#+BEGIN_SRC R :results output graphics :file "R-analysis/plots/inst.rate.dataset.2.png" :exports both :width 600 :height 400 :session rough.estimation.inst.rate
ggplot(d.4b.4c.II, aes(x=1:nrow(d.4b.4c.II),
                      y=COMP.4c.avg/COMP.4b.avg,
                      color=COMP.4c.avg,
                      size=events)) +
  geom_point() + xlab("Event") + ylab("Instruction Rate") +
...
#+RESULTS:
[[file:../R-analysis/plots/inst.rate.dataset.2.png]]

*Dataset 3*

#+BEGIN_SRC R :results output graphics :file "R-analysis/plots/inst.rate.dataset.3.png" :exports both :width 600 :height 400 :session rough.estimation.inst.rate
ggplot(d.4b.4c.III, aes(x=1:nrow(d.4b.4c.III),
                      y=COMP.4c.avg/COMP.4b.avg,
                      color=COMP.4c.avg,
                      size=events)) +
  geom_point() + xlab("Event") + ylab("Instruction Rate") +
...
#+RESULTS:
[[file:../R-analysis/plots/inst.rate.dataset.3.png]]

*Dataset 4*

#+BEGIN_SRC R :results output graphics :file "R-analysis/plots/inst.rate.dataset.4.png" :exports both :width 600 :height 400 :session rough.estimation.inst.rate
ggplot(d.4b.4c.IV, aes(x=1:nrow(d.4b.4c.IV),
                      y=COMP.4c.avg/COMP.4b.avg,
                      color=COMP.4c.avg,
                      size=events)) +
  geom_point() + xlab("Event") + ylab("Instruction Rate") +
...
#+RESULTS:
[[file:../R-analysis/plots/inst.rate.dataset.4.png]]

*Dataset 5*

#+BEGIN_SRC R :results output graphics :file "R-analysis/plots/inst.rate.dataset.5.png" :exports both :width 600 :height 400 :session rough.estimation.inst.rate
ggplot(d.4b.4c.V, aes(x=1:nrow(d.4b.4c.V),
                      y=COMP.4c.avg/COMP.4b.avg,
                      color=COMP.4c.avg,
                      size=events)) +
  geom_point() + xlab("Event") + ylab("Instruction Rate") +
...
#+RESULTS:
[[file:../R-analysis/plots/inst.rate.dataset.5.png]]

** Results
Instruction rate is almost *3.4e9 Instructions per sec*
