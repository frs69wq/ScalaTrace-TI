...
ggplot(d.B.8.4b.4c.I, aes(x=1:nrow(d.B.8.4b.4c.I),
  ...
  geom_hline(yintercept=inst.rate.B.8[1]) + scale_y_log10()
```
...
It will show if there is some variability when class or number of processes changes.  
